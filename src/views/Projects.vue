  ...
  <div class="fade-in">
    ...
    <div class="info-1">
      ...
      <p class="p-content-right">
        ...
        Firebase, and Tailwind.css. Jason helped implement a Training <br />
        page for allucent users to learn how to use their Web Application. <br />
        Also, a dynamic table has been introduced for company admins to <br />
